...
## 이 폴더의 역할
이 디렉터리는 `Distance-Vector Routing`를 공부할 때 반복해서 다시 볼 개념과 판단 근거만 남깁니다. 문제 이해의 출발점은 아니며, `problem/README.md`와 `python/README.md`를 읽은 뒤 필요한 문서만 다시 참조합니다.

## 먼저 볼 파일
- [`bellman-ford.md`](concepts/bellman-ford.md)
- [`count-to-infinity.md`](concepts/count-to-infinity.md)
