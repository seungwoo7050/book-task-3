...
- 보조 공개 표면: `docs/`
- 보조 공개 표면: `study/blog/04-Network-Diagnostics-and-Routing/traceroute/`
- 읽는 순서:
  1. `problem/README.md` - 문제 조건, 제공 자료, 성공 기준을 먼저 확인합니다.
  2. `python/README.md` - 현재 공개 답안 범위와 기준 명령을 확인합니다.
  3. `../../blog/04-Network-Diagnostics-and-Routing/traceroute/README.md` - 실제 소스 기준의 개발 chronology를 따라갑니다.
