...
```bash
cd study/Network-Diagnostics-and-Routing/routing/python/tests
...
```bash
make -C study/Network-Diagnostics-and-Routing/routing/problem run-solution TOPO=data/topology.json
make -C study/Network-Diagnostics-and-Routing/routing/problem run-solution TOPO=data/topology_5node.json
```
