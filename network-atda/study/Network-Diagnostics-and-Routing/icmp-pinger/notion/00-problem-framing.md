...
- 프로젝트: `ICMP Pinger`
- 상태: `verified`
- 기준 검증: `make -C study/Network-Diagnostics-and-Routing/icmp-pinger/problem test`
...
- `make -C study/Network-Diagnostics-and-Routing/icmp-pinger/problem test`가 통과한다.
