...
```bash
sudo make -C study/Network-Diagnostics-and-Routing/icmp-pinger/problem run-solution HOST=8.8.8.8 COUNT=4
sudo make -C study/Network-Diagnostics-and-Routing/icmp-pinger/problem test-live HOST=8.8.8.8
```
