...
- `cmake -S study/05-Game-Server-Capstone/tactical-arena-server/cpp -B study/05-Game-Server-Capstone/tactical-arena-server/cpp/build && cmake --build study/05-Game-Server-Capstone/tactical-arena-server/cpp/build`
