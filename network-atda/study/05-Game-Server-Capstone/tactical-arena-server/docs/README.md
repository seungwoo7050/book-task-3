...
## 이 폴더의 역할
이 디렉터리는 `Tactical Arena Server`를 공부할 때 반복해서 다시 볼 개념과 판단 근거만 남깁니다. 문제 이해의 출발점은 아니며, `problem/README.md`와 `cpp/README.md`를 읽은 뒤 필요한 문서만 다시 참조합니다.

## 먼저 볼 파일
- [`architecture.md`](concepts/architecture.md)
- [`load-testing.md`](concepts/load-testing.md)
