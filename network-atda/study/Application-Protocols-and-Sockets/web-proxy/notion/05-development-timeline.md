...
```bash
cd study/Application-Protocols-and-Sockets/web-proxy/python/tests
...
```bash
make -C study/Application-Protocols-and-Sockets/web-proxy/problem run-solution
```

터미널 2:

```bash
bash study/Application-Protocols-and-Sockets/web-proxy/problem/script/test_proxy.sh 8888
```
...
```bash
make -C study/Application-Protocols-and-Sockets/web-proxy/problem request
```
