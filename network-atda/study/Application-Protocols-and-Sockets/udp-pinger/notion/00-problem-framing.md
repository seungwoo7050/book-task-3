...
- 프로젝트: `UDP Pinger`
- 상태: `verified`
- 기준 검증: `make -C study/Application-Protocols-and-Sockets/udp-pinger/problem test`
...
- `make -C study/Application-Protocols-and-Sockets/udp-pinger/problem test`가 통과한다.
