...
- 프로젝트: `SMTP Client`
- 상태: `verified`
- 기준 검증: `make -C study/Application-Protocols-and-Sockets/smtp-client/problem test`
...
- `make -C study/Application-Protocols-and-Sockets/smtp-client/problem test`가 통과한다.
