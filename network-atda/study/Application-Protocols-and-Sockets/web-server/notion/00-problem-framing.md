...
- 프로젝트: `Web Server`
- 상태: `verified`
- 기준 검증: `make -C study/Application-Protocols-and-Sockets/web-server/problem test`
...
- `make -C study/Application-Protocols-and-Sockets/web-server/problem test`가 통과한다.
