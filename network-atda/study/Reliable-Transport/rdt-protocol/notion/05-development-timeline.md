...
```bash
cd study/Reliable-Transport/rdt-protocol/python/tests
...
```bash
make -C study/Reliable-Transport/rdt-protocol/problem run-solution-rdt3
make -C study/Reliable-Transport/rdt-protocol/problem run-solution-gbn
```
