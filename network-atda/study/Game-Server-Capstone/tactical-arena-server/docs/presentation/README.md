...
```bash
cmake -S study/Game-Server-Capstone/tactical-arena-server/cpp -B study/Game-Server-Capstone/tactical-arena-server/cpp/build
cmake --build study/Game-Server-Capstone/tactical-arena-server/cpp/build
python3 study/Game-Server-Capstone/tactical-arena-server/problem/script/presentation_capture.py study/Game-Server-Capstone/tactical-arena-server/cpp/build
python3 study/Game-Server-Capstone/tactical-arena-server/problem/script/presentation_load_capture.py study/Game-Server-Capstone/tactical-arena-server/cpp/build
```
