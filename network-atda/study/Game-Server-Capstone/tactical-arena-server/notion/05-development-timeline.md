...
```bash
make -C study/Game-Server-Capstone/tactical-arena-server/problem run-bot-demo
```
...
```bash
sqlite3 study/Game-Server-Capstone/tactical-arena-server/problem/data/arena.sqlite3 '.tables'
```
...
```bash
make -C study/Game-Server-Capstone/tactical-arena-server/problem load-test
```
