...
from app.db.models.platform import Invite, Membership, Notification, Project, Task
...
class PlatformRepository:
    ...
    def list_queued_notifications(self) -> list[Notification]:
        return list(self.session.execute(select(Notification).where(Notification.status == "queued")).scalars())
