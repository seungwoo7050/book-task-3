# D-data-api-lab 학습 로그

이 폴더는 D-data-api-lab의 현재 공개용 학습 로그입니다. 설계 문서가 답의 구조를 설명한다면, 여기서는 구현 순서, 실패 사례, 재현 경로를 기록합니다.

이 폴더는 현재 공개용 학습 노트입니다. 데이터 API의 범위, 규칙, 실패 사례를 이 노트만으로 이해할 수 있게 정리했습니다.
