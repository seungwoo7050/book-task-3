# I-event-integration-lab 학습 로그

이 폴더는 I-event-integration-lab의 현재 공개용 학습 로그입니다. 설계 문서가 답의 구조를 설명한다면, 여기서는 구현 순서, 실패 사례, 재현 경로를 기록합니다.

이 노트는 I 랩을 “저장과 전달은 같은 성공이 아니다”라는 질문으로 다시 읽게 만드는 보조 문서다.
