# K-distributed-ops-lab 학습 로그

이 폴더는 K-distributed-ops-lab의 현재 공개용 학습 로그입니다. 설계 문서가 답의 구조를 설명한다면, 여기서는 구현 순서, 실패 사례, 재현 경로를 기록합니다.

이 노트는 K 랩을 “다중 서비스 구조도 운영 질문에 답할 수 있어야 한다”는 관점으로 읽게 만드는 보조 문서다.
