...
- [02-arenaserv](02-arenaserv/README.md)에서 room queue, snapshot, reconnect를 포함한 pure TCP capstone으로 다시 합친다.
...
| 2 | [02-arenaserv](02-arenaserv/README.md) | authoritative TCP arena server와 multi-client smoke test |

## 읽는 순서

1. [01-ticklab/README.md](01-ticklab/README.md)
2. [02-arenaserv/README.md](02-arenaserv/README.md)
3. 공용 런타임을 다시 보려면 [../shared-core/01-eventlab/README.md](../shared-core/01-eventlab/README.md)
