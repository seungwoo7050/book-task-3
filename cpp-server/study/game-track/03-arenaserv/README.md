...
- 실제 소스와 테스트만으로 다시 읽는 chronology는 [../../blog/game-track/03-arenaserv/README.md](../../blog/game-track/03-arenaserv/README.md)에서 이어진다.

## 다음 단계

- rollback correction을 먼저 읽으려면 [../02-rollbacklab/README.md](../02-rollbacklab/README.md)
