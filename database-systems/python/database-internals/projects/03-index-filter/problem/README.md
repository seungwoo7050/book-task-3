...
이 문서는 03 Index Filter 프로젝트에서 “무엇을 구현해야 하는가”를 현재 기준으로 다시 설명합니다. 과거 과제군에서 출발한 아이디어는 남기되, 현재 레포에 없는 로컬 경로를 전제로 설명하지는 않습니다.
...
- 현재 프로젝트에서의 재구성: Python 트랙에서도 동일한 개념 범위를 유지하되, 입문자가 읽기 쉬운 단일 구현 경로로 정리했습니다.
