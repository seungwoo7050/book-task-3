...
이 문서는 01 Mini LSM Store 프로젝트에서 “무엇을 구현해야 하는가”를 현재 기준으로 다시 설명합니다. 과거 과제군에서 출발한 아이디어는 남기되, 현재 레포에 없는 로컬 경로를 전제로 설명하지는 않습니다.
...
- 현재 프로젝트에서의 재구성: Python 입문 트랙에서는 memtable과 SSTable prerequisite를 한 슬롯으로 접어, 저장 엔진 전체 흐름을 더 빨리 잡도록 재구성했습니다.
