...
이 문서는 04 Buffer Pool 프로젝트에서 “무엇을 구현해야 하는가”를 현재 기준으로 다시 설명합니다. 과거 과제군에서 출발한 아이디어는 남기되, 현재 레포에 없는 로컬 경로를 전제로 설명하지는 않습니다.
...
- 현재 프로젝트에서의 재구성: Python 트랙에서는 웹 백엔드 학습자도 이해하기 쉽도록 file-backed page cache 관점에서 설명을 보강했습니다.
