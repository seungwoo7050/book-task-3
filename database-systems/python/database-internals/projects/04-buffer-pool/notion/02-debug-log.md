...
- 확인 테스트: `test_eviction_after_unpin`
...
- 확인 테스트: `test_lru_basic_operations`, `test_lru_eviction_and_promotion`, `test_lru_ordering_and_delete`
