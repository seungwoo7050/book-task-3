...
- 의심 파일: `../src/wal_recovery/store.py`
- 깨지는 징후: 중간 corruption 이후 garbage를 더 읽어 버리면 복원 상태가 예측 불가능해집니다.
- 확인 테스트: `test_stop_at_corrupted_record`, `test_recover_nonexistent_and_truncated`
...
- 확인 테스트: `test_recover_delete_records`
...
- 확인 테스트: `test_store_recovers_from_wal_after_reopen`, `test_force_flush_rotates_wal`
