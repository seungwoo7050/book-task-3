...
이 문서는 05 MVCC 프로젝트에서 “무엇을 구현해야 하는가”를 현재 기준으로 다시 설명합니다. 과거 과제군에서 출발한 아이디어는 남기되, 현재 레포에 없는 로컬 경로를 전제로 설명하지는 않습니다.
...
- 현재 프로젝트에서의 재구성: Python 트랙의 마지막 저장 엔진 슬롯으로 두어, 백엔드 학습자가 트랜잭션 가시성까지 경험하도록 재배치했습니다.
