...
- 의심 파일: `../src/rpc_framing/core.py`
- 깨지는 징후: 헤더와 payload가 여러 번에 나눠 들어올 때 decoder가 조합을 잘못하면 이후 모든 응답이 무너집니다.
- 확인 테스트: `test_decoder_handles_split_chunks`
...
- 확인 테스트: `test_rpc_handles_concurrent_calls`
...
- 확인 테스트: `test_rpc_propagates_server_errors_and_timeout`
