...
| 4 | [`04-clustered-kv-capstone`](04-clustered-kv-capstone/README.md) | 지금까지 배운 저장 엔진·분산 개념을 하나로 묶는 캡스톤 | Go DDIA track 또는 FastAPI 기반 확장판 |
...
이 트랙을 끝낸 뒤 Go 분산 트랙의 Raft-lite나 더 큰 capstone 확장으로 넘어가면 좋습니다.
