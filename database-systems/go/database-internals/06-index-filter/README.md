...
3. `internal/`와 `tests/`를 함께 읽고, 마지막에 `cmd/index-filter/`로 동작 예시를 확인합니다.
...
- `internal/bloomfilter/`, `internal/sparseindex/`, `internal/sstable/`, `tests/`, `cmd/index-filter/`: 실제 구현과 검증 코드
- `notion/`: 현재 공개용 학습 노트
