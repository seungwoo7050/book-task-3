...
## 검증 앵커
- 확인일: 2026-03-10
- 테스트 파일: `../tests/buffer_pool_test.go`, `../tests/lru_cache_test.go`
- 다시 돌릴 테스트 이름: `TestFetchPageFromDisk`, `TestReturnCachedPage`, `TestTrackDirtyPages`, `TestEvictionAfterUnpin`, `TestLRUBasicOperations`, `TestLRUEvictionAndPromotion`, `TestLRUOrderingAndDelete`
- 데모 경로: `../cmd/buffer-pool/main.go`
- 데모가 보여 주는 장면: sample file에서 page 1을 읽어 prefix를 출력합니다.
