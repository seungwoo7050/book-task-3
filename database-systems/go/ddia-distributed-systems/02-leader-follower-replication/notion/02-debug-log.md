...
- 의심 파일: `../internal/replication/replication.go`
- 깨지는 징후: 연속 offset이 깨지면 watermark 기반 재동기화가 성립하지 않습니다.
- 확인 테스트: `TestReplicationLogAssignsSequentialOffsets`
...
- 확인 테스트: `TestFollowerApplyIsIdempotent`
...
- 확인 테스트: `TestReplicateOnceIncrementalAndDeletes`
