...
```bash
mkdir -p go/ddia-distributed-systems/projects/02-leader-follower-replication
cd go/ddia-distributed-systems/projects/02-leader-follower-replication

go mod init study.local/go/ddia-distributed-systems/projects/02-leader-follower-replication
```
