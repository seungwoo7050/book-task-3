...
```bash
mkdir -p go/ddia-distributed-systems/projects/05-clustered-kv-capstone
cd go/ddia-distributed-systems/projects/05-clustered-kv-capstone

go mod init study.local/go/ddia-distributed-systems/projects/05-clustered-kv-capstone
```
...
### go.mod 의존성 설정
```bash
go mod edit -require study.local/go/shared@v0.0.0
go mod edit -replace study.local/go/shared=../../../shared
```
