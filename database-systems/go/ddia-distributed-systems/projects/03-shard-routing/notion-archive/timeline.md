...
```bash
mkdir -p go/ddia-distributed-systems/projects/03-shard-routing
cd go/ddia-distributed-systems/projects/03-shard-routing

go mod init study.local/go/ddia-distributed-systems/projects/03-shard-routing
```
