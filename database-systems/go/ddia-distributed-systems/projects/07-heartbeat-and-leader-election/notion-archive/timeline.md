...
```bash
mkdir -p go/ddia-distributed-systems/projects/07-heartbeat-and-leader-election/{cmd/leader-election,docs/concepts,docs/references,internal/election,notion,notion-archive,problem,tests}
cd go/ddia-distributed-systems/projects/07-heartbeat-and-leader-election
go mod init study.local/go/ddia-distributed-systems/projects/07-heartbeat-and-leader-election
```
