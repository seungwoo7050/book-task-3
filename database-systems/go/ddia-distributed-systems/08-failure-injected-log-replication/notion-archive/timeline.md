...
```bash
mkdir -p go/ddia-distributed-systems/08-failure-injected-log-replication/{cmd/failure-replication,docs/concepts,docs/references,internal/replication,notion,notion-archive,problem,tests}
cd go/ddia-distributed-systems/08-failure-injected-log-replication
go mod init study.local/ddia-distributed-systems/08-failure-injected-log-replication
```
