...
```bash
mkdir -p go/ddia-distributed-systems/06-quorum-and-consistency/{cmd/quorum-demo,docs/concepts,docs/references,internal/quorum,notion,notion-archive,problem,tests}
cd go/ddia-distributed-systems/06-quorum-and-consistency
go mod init study.local/ddia-distributed-systems/06-quorum-and-consistency
```
