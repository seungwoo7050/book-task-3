...
- 뒤쪽 경계까지 가고 싶다면: [08 MVCC](08-mvcc/00-series-map.md)
...
| 08 MVCC | snapshot isolation을 위한 version chain과 transaction manager를 구현합니다. | `go test ok, 7 tests`, demo `t2 sees x=v1` | [00-series-map.md](08-mvcc/00-series-map.md) |
