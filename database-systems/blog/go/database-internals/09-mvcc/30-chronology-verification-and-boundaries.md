# 30 09 MVCC를 다시 돌려 보며 검증 신호와 경계를 정리하기
...
```bash
$ GOWORK=off go test ./...
?   	study.local/go/database-internals/projects/09-mvcc/cmd/mvcc	[no test files]
?   	study.local/go/database-internals/projects/09-mvcc/internal/mvcc	[no test files]
