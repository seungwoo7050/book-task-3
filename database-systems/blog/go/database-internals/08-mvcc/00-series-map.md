...
`08 MVCC`은 Database Internals 트랙에서 8번째로 만나는 프로젝트다. snapshot isolation을 위한 version chain과 transaction manager를 구현합니다. 여기서는 완성된 해설보다, 테스트와 코드가 어디서 같은 문제를 가리키는지 차례대로 따라간다.
...
- `database-systems/go/database-internals/projects/08-mvcc/README.md`
- `database-systems/go/database-internals/projects/08-mvcc/problem/README.md`
- `database-systems/go/database-internals/projects/08-mvcc/docs/README.md`
