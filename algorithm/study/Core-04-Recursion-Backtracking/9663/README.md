...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 9663 N-Queen` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
| 정식 검증 | `make -C study/Core-04-Recursion-Backtracking/9663/problem test` |

## 문제가 뭐였나
- 문제: `N-Queen`
- 트랙: `Core-04-Recursion-Backtracking`
...
## 이 레포의 답
- 한 줄 답: `열/대각선 점유 배열을 이용한 N-Queen backtracking`
...
- code-first blog series: [../../blog/Core-04-Recursion-Backtracking/9663/00-series-map.md](../../blog/Core-04-Recursion-Backtracking/9663/00-series-map.md)

## 어떻게 검증하나
- 정식 검증: `make -C study/Core-04-Recursion-Backtracking/9663/problem test`
- 대표 실행: `make -C study/Core-04-Recursion-Backtracking/9663/problem run-py`
- 비교 실행: `make -C study/Core-04-Recursion-Backtracking/9663/problem run-cpp`
