...
| Legacy Source | `legacy/core/04-recursion-backtracking/silver-15649` |
| Tier | Silver |
| CLRS | Ch 4 |
...
Print all sequences of length $M$ chosen from $\{1, 2, \dots, N\}$ without repetition (permutations), in lexicographic order.
