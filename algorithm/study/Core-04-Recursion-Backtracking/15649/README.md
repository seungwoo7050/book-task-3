...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 15649 N과 M (1)` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
| 정식 검증 | `make -C study/Core-04-Recursion-Backtracking/15649/problem test` |
...
## 이 레포의 답
- 한 줄 답: `방문 배열과 경로 배열을 사용하는 백트래킹(permutation generation)`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-04-Recursion-Backtracking/15649/problem test`
- 대표 실행: `make -C study/Core-04-Recursion-Backtracking/15649/problem run-py`
