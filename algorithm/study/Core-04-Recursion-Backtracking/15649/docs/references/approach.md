...
- 전략: `방문 배열과 경로 배열을 사용하는 백트래킹(permutation generation)`
...
- 출력 버퍼 조립 실수
- 재귀 종료 조건(depth==M) 오류
- 테스트는 통과했더라도, BOJ 15649 코드 변경 시에는 동일 체크리스트를 다시 실행해야 한다.

## 코드 매핑

- Python 기본 구현: `../../python/src/solution.py`
- 빠른 검증: `make -C study/Core-04-Recursion-Backtracking/15649/problem test`
