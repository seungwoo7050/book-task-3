...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 10872 팩토리얼` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
| 정식 검증 | `make -C study/Core-04-Recursion-Backtracking/10872/problem test` |
...
## 이 레포의 답
- 한 줄 답: `재귀 또는 반복으로 N!을 누적 계산하는 기본 recursion`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-04-Recursion-Backtracking/10872/problem test`
- 대표 실행: `make -C study/Core-04-Recursion-Backtracking/10872/problem run-py`
