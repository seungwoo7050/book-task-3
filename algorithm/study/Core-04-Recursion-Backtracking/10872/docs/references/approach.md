...
- 전략: `재귀 또는 반복으로 N!을 누적 계산하는 기본 recursion`
...
- int 범위 고려 누락
- N=0 처리 누락
- 테스트는 통과했더라도, BOJ 10872 코드 변경 시에는 동일 체크리스트를 다시 실행해야 한다.

## 코드 매핑

- Python 기본 구현: `../../python/src/solution.py`
- 빠른 검증: `make -C study/Core-04-Recursion-Backtracking/10872/problem test`
