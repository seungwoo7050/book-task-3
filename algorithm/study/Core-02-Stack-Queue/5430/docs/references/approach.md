...
- 전략: `함수 문자열을 reverse flag + deque 양끝 제거로 lazy evaluation`
...
- 배열 파싱에서 [] 케이스를 잘못 처리
- 테스트는 통과했더라도, BOJ 5430 코드 변경 시에는 동일 체크리스트를 다시 실행해야 한다.

## 코드 매핑

- Python 기본 구현: `../../python/src/solution.py`
- C++ 비교 구현: `../../cpp/src/solution.cpp`
- 빠른 검증: `make -C study/Core-02-Stack-Queue/5430/problem test`
