...
| Item | Detail |
| :--- | :--- |
| Track | `Core-02-Stack-Queue` |
| Legacy Source | `legacy/core/02-stack-queue/gold-5430` |
| Tier | Gold |
| CLRS | Ch 10.1 |
...
AC is a language with two functions: **R**: Reverse the array. **D**: Delete the first element. If the array is empty, produce an error.
