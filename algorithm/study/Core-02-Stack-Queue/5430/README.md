...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 5430 AC` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
| 정식 검증 | `make -C study/Core-02-Stack-Queue/5430/problem test` |

## 문제가 뭐였나
- 문제: `AC`
- 트랙: `Core-02-Stack-Queue`
...
- code-first blog series: [../../blog/Core-02-Stack-Queue/5430/00-series-map.md](../../blog/Core-02-Stack-Queue/5430/00-series-map.md)

## 어떻게 검증하나
- 정식 검증: `make -C study/Core-02-Stack-Queue/5430/problem test`
- 대표 실행: `make -C study/Core-02-Stack-Queue/5430/problem run-py`
- 비교 실행: `make -C study/Core-02-Stack-Queue/5430/problem run-cpp`
