...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 2164 카드2` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `큐에서 앞 원소 제거 후 다음 원소를 뒤로 보내는 카드 시뮬레이션`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-02-Stack-Queue/2164/problem test`
- 대표 실행: `make -C study/Core-02-Stack-Queue/2164/problem run-py`
