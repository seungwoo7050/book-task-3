...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 10828 스택` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `명령형 스택 연산을 조건 분기와 리스트 push/pop으로 구현`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-02-Stack-Queue/10828/problem test`
- 대표 실행: `make -C study/Core-02-Stack-Queue/10828/problem run-py`
