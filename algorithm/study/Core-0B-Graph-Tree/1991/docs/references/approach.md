...
- 전략: `이진 트리 노드 맵을 구성하고 preorder/inorder/postorder 재귀 순회`
...
- 순회 함수 호출 순서 오류
- 출력 줄바꿈 누락
- 테스트는 통과했더라도, BOJ 1991 코드 변경 시에는 동일 체크리스트를 다시 실행해야 한다.

## 코드 매핑

- Python 기본 구현: `../../python/src/solution.py`
- 빠른 검증: `make -C study/Core-0B-Graph-Tree/1991/problem test`
