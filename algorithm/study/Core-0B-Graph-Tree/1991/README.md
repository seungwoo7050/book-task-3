...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 1991 트리 순회` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
| 정식 검증 | `make -C study/Core-0B-Graph-Tree/1991/problem test` |
...
## 이 레포의 답
- 한 줄 답: `이진 트리 노드 맵을 구성하고 preorder/inorder/postorder 재귀 순회`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-0B-Graph-Tree/1991/problem test`
- 대표 실행: `make -C study/Core-0B-Graph-Tree/1991/problem run-py`
