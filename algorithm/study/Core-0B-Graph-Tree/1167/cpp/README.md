...
- 실행: `make -C study/Core-0B-Graph-Tree/1167/problem run-cpp`
- 검증: `make -C study/Core-0B-Graph-Tree/1167/problem test`

## 현재 범위

- 비교 답안: `임의 정점에서 최원점 탐색 후 한 번 더 탐색하는 트리 지름(two-pass)`
