...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 1167 트리의 지름` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `임의 정점에서 최원점 탐색 후 한 번 더 탐색하는 트리 지름(two-pass)`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-0B-Graph-Tree/1167/problem test`
- 대표 실행: `make -C study/Core-0B-Graph-Tree/1167/problem run-py`
- 비교 실행: `make -C study/Core-0B-Graph-Tree/1167/problem run-cpp`
