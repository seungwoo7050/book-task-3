...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 11725 트리의 부모 찾기` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `루트 1에서 BFS/DFS로 각 노드의 부모를 기록`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-0B-Graph-Tree/11725/problem test`
- 대표 실행: `make -C study/Core-0B-Graph-Tree/11725/problem run-py`
