...
- 실행: `make -C study/Core-0A-Priority-Queue/1715/problem run-cpp`
- 검증: `make -C study/Core-0A-Priority-Queue/1715/problem test`

## 현재 범위

- 비교 답안: `가장 작은 두 묶음을 반복 병합하는 Huffman-style greedy`
