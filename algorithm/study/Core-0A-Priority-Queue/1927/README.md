...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 1927 최소 힙` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `최소 힙(min-heap)으로 0 명령 시 최솟값을 추출`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-0A-Priority-Queue/1927/problem test`
- 대표 실행: `make -C study/Core-0A-Priority-Queue/1927/problem run-py`
