...
| Legacy Source | `legacy/core/0A-priority-queue/silver-1927` |
| Tier | Silver |
| CLRS | Ch 6, 19 |
...
Implement a min-heap supporting two operations: **Insert** a natural number $x$. **Extract** and print the minimum value (print 0 if the heap is empty).
