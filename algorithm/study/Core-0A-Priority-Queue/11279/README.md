...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 11279 최대 힙` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `최대 힙(max-heap)에 삽입/삭제 연산을 매 명령마다 처리`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-0A-Priority-Queue/11279/problem test`
- 대표 실행: `make -C study/Core-0A-Priority-Queue/11279/problem run-py`
