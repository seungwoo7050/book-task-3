...
- 전략: `최대 힙(max-heap)에 삽입/삭제 연산을 매 명령마다 처리`
- 공개 구현: `../../python/src/solution.py`
- 정식 검증: `make -C study/Core-0A-Priority-Queue/11279/problem test`
...
- 빈 힙 처리 누락
- 출력 버퍼 누락
- 테스트는 통과했더라도, BOJ 11279 코드 변경 시에는 동일 체크리스트를 다시 실행해야 한다.

## 코드 매핑

- Python 기본 구현: `../../python/src/solution.py`
- 빠른 검증: `make -C study/Core-0A-Priority-Queue/11279/problem test`
