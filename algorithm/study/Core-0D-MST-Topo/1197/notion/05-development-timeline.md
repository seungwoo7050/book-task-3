...
- 현재 기준 경로: `study/Core-0D-MST-Topo/1197`
...
- `최소 스패닝 트리`에서는 `그래프 전체 구조를 만들거나 순서를 고정하는 규칙을 설명하는 연습`를 실제 명령과 문서 흐름으로 다시 밟아 볼 수 있어야 학습 기록으로서 가치가 생긴다.
