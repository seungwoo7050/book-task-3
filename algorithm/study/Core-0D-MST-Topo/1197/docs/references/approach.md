...
- 전략: `간선 가중치 정렬 + 유니온파인드로 MST를 구성하는 Kruskal`
...
- union 조건 반전
- 정점 번호 범위 초기화 오류
- 테스트는 통과했더라도, BOJ 1197 코드 변경 시에는 동일 체크리스트를 다시 실행해야 한다.

## 코드 매핑

- Python 기본 구현: `../../python/src/solution.py`
- C++ 비교 구현: `../../cpp/src/solution.cpp`
- 빠른 검증: `make -C study/Core-0D-MST-Topo/1197/problem test`
