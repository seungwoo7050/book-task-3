...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 2252 줄 세우기` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `진입차수(indegree) 기반 Kahn 알고리즘으로 위상정렬 수행`
...
- code-first blog series: [../../blog/Core-0D-MST-Topo/2252/00-series-map.md](../../blog/Core-0D-MST-Topo/2252/00-series-map.md)

## 어떻게 검증하나
- 정식 검증: `make -C study/Core-0D-MST-Topo/2252/problem test`
- 대표 실행: `make -C study/Core-0D-MST-Topo/2252/problem run-py`
- 비교 실행: `make -C study/Core-0D-MST-Topo/2252/problem run-cpp`
