...
- 현재 기준 경로: `study/Core-Bridges/1717`
...
Bridge 프로젝트로 직접 생성. MST 전에 Union-Find를 독립 훈련.

### 단계 2: Python 구현

Path splitting 기반 find + 번호 기준 union.
...
- `집합의 표현`에서는 `다음 트랙에서 필요한 선행 개념을 별도 실습으로 고정하는 연습`를 실제 명령과 문서 흐름으로 다시 밟아 볼 수 있어야 학습 기록으로서 가치가 생긴다.
