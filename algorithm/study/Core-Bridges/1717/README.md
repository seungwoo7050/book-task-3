...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 1717 집합의 표현` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `다음 트랙에서 필요한 선행 개념을 별도 실습으로 고정하는 연습`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-Bridges/1717/problem test`
- 대표 실행: `make -C study/Core-Bridges/1717/problem run-py`
