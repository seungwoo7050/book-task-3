...
- 실행: `make -C study/Core-05-Simulation/14503/problem run-cpp`
- 검증: `make -C study/Core-05-Simulation/14503/problem test`

## 현재 범위

- 비교 답안: `현재 방향 기준으로 좌회전 탐색을 반복하는 로봇 청소 시뮬레이션`
