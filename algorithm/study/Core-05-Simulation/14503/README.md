...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 14503 로봇 청소기` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
| 정식 검증 | `make -C study/Core-05-Simulation/14503/problem test` |

## 문제가 뭐였나
- 문제: `로봇 청소기`
- 트랙: `Core-05-Simulation`
- 학습 초점: 복잡한 설명을 작은 상태 전이 규칙으로 나누어 구현하는 연습
- CLRS 연결: `Implementation discipline`
...
## 이 레포의 답
- 한 줄 답: `현재 방향 기준으로 좌회전 탐색을 반복하는 로봇 청소 시뮬레이션`
...
- code-first blog series: [../../blog/Core-05-Simulation/14503/00-series-map.md](../../blog/Core-05-Simulation/14503/00-series-map.md)

## 어떻게 검증하나
- 정식 검증: `make -C study/Core-05-Simulation/14503/problem test`
- 대표 실행: `make -C study/Core-05-Simulation/14503/problem run-py`
- 비교 실행: `make -C study/Core-05-Simulation/14503/problem run-cpp`
