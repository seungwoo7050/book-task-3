...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 14891 톱니바퀴` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
| 정식 검증 | `make -C study/Core-05-Simulation/14891/problem test` |
...
## 이 레포의 답
- 한 줄 답: `기어 맞물림 방향 전파를 먼저 계산한 뒤 동시 회전 적용`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-05-Simulation/14891/problem test`
- 대표 실행: `make -C study/Core-05-Simulation/14891/problem run-py`
