...
- 전략: `기어 맞물림 방향 전파를 먼저 계산한 뒤 동시 회전 적용`
...
- 점수 계산 비트 위치 해석 오류
- 테스트는 통과했더라도, BOJ 14891 코드 변경 시에는 동일 체크리스트를 다시 실행해야 한다.

## 코드 매핑

- Python 기본 구현: `../../python/src/solution.py`
- 빠른 검증: `make -C study/Core-05-Simulation/14891/problem test`
