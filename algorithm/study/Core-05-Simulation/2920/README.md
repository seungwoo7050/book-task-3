...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 2920 음계` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `인접 음계 차이를 검사해 ascending/descending/mixed 판정`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-05-Simulation/2920/problem test`
- 대표 실행: `make -C study/Core-05-Simulation/2920/problem run-py`
