...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 2750 수 정렬하기` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `입력 수열을 정렬해 오름차순으로 출력하는 기본 sorting`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-06-Sorting/2750/problem test`
- 대표 실행: `make -C study/Core-06-Sorting/2750/problem run-py`
