# 0x11 상각 분석 실습 학습 프로젝트

| 항목 | 내용 |
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `상각 분석 실습` 개념을 `CLRS Ch 17` 맥락에서 실행 가능한 입출력 실험으로 다시 정리한 심화 프로젝트 |
| 정식 검증 | `make -C study/Advanced-CLRS/0x11-amortized-analysis-lab/problem test` |
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Advanced-CLRS/0x11-amortized-analysis-lab/problem test`
- 대표 실행: `make -C study/Advanced-CLRS/0x11-amortized-analysis-lab/problem run-py`
