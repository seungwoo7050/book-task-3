...
- 현재 기준 경로: `study/Advanced-CLRS/0x19-approximation-lab`
...
### 단계 1: Greedy Set Cover

탐욕 선택 + 결정적 타이브레이킹.

### 단계 2: 2-Approx Vertex Cover

간선 선택 → 양끝점 추가 → 인접 간선 제거.
...
- `근사 알고리즘 실습`에서는 `근사 알고리즘 실습의 핵심 아이디어를 작은 실험과 자동 검증으로 다시 설명하는 연습`를 실제 명령과 문서 흐름으로 다시 밟아 볼 수 있어야 학습 기록으로서 가치가 생긴다.
