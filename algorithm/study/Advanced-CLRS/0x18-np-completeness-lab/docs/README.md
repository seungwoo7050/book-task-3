...
- [concepts/certificate-verifier-concept.md](concepts/certificate-verifier-concept.md)
- [concepts/edge-cases.md](concepts/edge-cases.md)

## 기준 명령

- 기준 검증: `make -C study/Advanced-CLRS/0x18-np-completeness-lab/problem test`
