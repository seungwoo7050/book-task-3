...
양의 리터럴 = 변수 번호, 음의 리터럴 = 음수. assignment 비트마스크에서 인덱스 변환 주의.
...
- `NP-완전성 실습`는 `NP-완전성 실습의 핵심 아이디어를 작은 실험과 자동 검증으로 다시 설명하는 연습`를 연습하는 프로젝트라서, 작은 경계 조건 하나가 전체 상태 전이를 망가뜨릴 수 있다.
