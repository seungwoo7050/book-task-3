...
- 현재 기준 경로: `study/Advanced-CLRS/0x16-computational-geometry`
...
### 단계 1: cross product 유틸

방향 판정 함수 구현.

### 단계 2: Convex Hull

Andrew's Monotone Chain — lower + upper hull.

### 단계 3: Segment Intersection

cross product + on_segment.
...
- `계산 기하 실습`에서는 `계산 기하 실습의 핵심 아이디어를 작은 실험과 자동 검증으로 다시 설명하는 연습`를 실제 명령과 문서 흐름으로 다시 밟아 볼 수 있어야 학습 기록으로서 가치가 생긴다.
