# 0x13 합칠 수 있는 힙 브리지 학습 프로젝트

| 항목 | 내용 |
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `합칠 수 있는 힙 브리지` 개념을 `CLRS Ch 19` 맥락에서 실행 가능한 입출력 실험으로 다시 정리한 심화 프로젝트 |
| 정식 검증 | `make -C study/Advanced-CLRS/0x13-meldable-heap/problem test` |
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Advanced-CLRS/0x13-meldable-heap/problem test`
- 대표 실행: `make -C study/Advanced-CLRS/0x13-meldable-heap/problem run-py`
