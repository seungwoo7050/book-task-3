...
- 현재 기준 경로: `study/Advanced-CLRS/0x13-meldable-heap`
...
### 단계 3: PairingHeap 클래스

push/pop/meld + 다중 힙 딕셔너리.
...
- `합칠 수 있는 힙 브리지`에서는 `합칠 수 있는 힙 브리지의 핵심 아이디어를 작은 실험과 자동 검증으로 다시 설명하는 연습`를 실제 명령과 문서 흐름으로 다시 밟아 볼 수 있어야 학습 기록으로서 가치가 생긴다.
