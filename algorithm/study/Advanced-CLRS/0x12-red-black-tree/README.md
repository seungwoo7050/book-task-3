# 0x12 — Red-Black Tree Insert and Validate
...
| Project Focus | Insertion, search, inorder traversal, and invariant validation |

## Summary

레드-블랙 트리의 회전과 recoloring을 구현하고, B-tree는 docs에서 대응 개념으로 비교한다.

이 프로젝트는 BOJ 문제가 아니라 CLRS 주제를 직접 재현 가능한 입력/출력 문제로 바꾼 study project다.

## Curriculum Note

원안의 "red-black + B-tree"는 한 프로젝트 범위가 과도해서, 구현은 red-black insertion에 집중하고 B-tree는 읽기 경로로 남긴다.
