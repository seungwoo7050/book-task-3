# 0x12 레드-블랙 트리 삽입과 검증 학습 프로젝트

| 항목 | 내용 |
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `레드-블랙 트리 삽입과 검증` 개념을 `CLRS Ch 13, 18` 맥락에서 실행 가능한 입출력 실험으로 다시 정리한 심화 프로젝트 |
| 정식 검증 | `make -C study/Advanced-CLRS/0x12-red-black-tree/problem test` |
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Advanced-CLRS/0x12-red-black-tree/problem test`
- 대표 실행: `make -C study/Advanced-CLRS/0x12-red-black-tree/problem run-py`
