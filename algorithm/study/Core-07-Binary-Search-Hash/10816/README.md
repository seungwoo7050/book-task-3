...
| Legacy Source | `legacy/core/07-binary-search-hash/silver-10816` |
| Tier | Silver |
| CLRS | Ch 11, 12.3 |
...
Sanggeun has $N$ number cards. Given $M$ query integers, for each query print how many cards have that number.
