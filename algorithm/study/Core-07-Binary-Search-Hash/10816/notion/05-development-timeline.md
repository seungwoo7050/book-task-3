...
- 현재 기준 경로: `study/Core-07-Binary-Search-Hash/10816`
...
- `숫자 카드 2`에서는 `탐색 대상을 재정의하고 자료구조 또는 매개변수 탐색으로 문제를 다시 보는 연습`를 실제 명령과 문서 흐름으로 다시 밟아 볼 수 있어야 학습 기록으로서 가치가 생긴다.
