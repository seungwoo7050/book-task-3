...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 5397 키로거` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `키 입력 문자열을 좌/우 버퍼로 시뮬레이션하는 keylogger 처리`
...
- code-first blog series: [../../blog/Core-01-Array-List/5397/00-series-map.md](../../blog/Core-01-Array-List/5397/00-series-map.md)

## 어떻게 검증하나
- 정식 검증: `make -C study/Core-01-Array-List/5397/problem test`
- 대표 실행: `make -C study/Core-01-Array-List/5397/problem run-py`
- 비교 실행: `make -C study/Core-01-Array-List/5397/problem run-cpp`
