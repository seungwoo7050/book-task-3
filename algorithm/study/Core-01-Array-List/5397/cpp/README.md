...
- 실행: `make -C study/Core-01-Array-List/5397/problem run-cpp`
- 검증: `make -C study/Core-01-Array-List/5397/problem test`

## 현재 범위

- 비교 답안: `키 입력 문자열을 좌/우 버퍼로 시뮬레이션하는 keylogger 처리`
