...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 1406 에디터` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `커서를 기준으로 좌/우 스택(또는 리스트) 두 개를 유지하는 editor simulation`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-01-Array-List/1406/problem test`
- 대표 실행: `make -C study/Core-01-Array-List/1406/problem run-py`
