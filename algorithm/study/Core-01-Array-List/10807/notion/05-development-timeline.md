...
- 현재 기준 경로: `study/Core-01-Array-List/10807`
...
provenance 메모: 이전 마이그레이션 기록상 원본 경로는 `legacy/core/01-array-list/bronze-10807`였다. 현재 읽을 기준 경로는 `study/Core-01-Array-List/10807`이다.
...
- `개수 세기`에서는 `순차 자료구조를 선택하고 편집 연산의 비용 모델을 설명하는 연습`를 실제 명령과 문서 흐름으로 다시 밟아 볼 수 있어야 학습 기록으로서 가치가 생긴다.
