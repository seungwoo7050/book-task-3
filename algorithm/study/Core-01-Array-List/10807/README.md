...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 10807 개수 세기` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `단일 선형 스캔으로 목표 값 v의 출현 횟수를 집계`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-01-Array-List/10807/problem test`
- 대표 실행: `make -C study/Core-01-Array-List/10807/problem run-py`
