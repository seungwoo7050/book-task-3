...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 1916 최소비용 구하기` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `우선순위 큐 기반 Dijkstra로 시작-도착 최소 비용 계산`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-0C-Shortest-Path/1916/problem test`
- 대표 실행: `make -C study/Core-0C-Shortest-Path/1916/problem run-py`
