...
| Legacy Source | `legacy/core/0C-shortest-path/bronze-1916` |
| Tier | Bronze |
| CLRS | Ch 24 |
| Problem URL | https://www.acmicpc.net/problem/1916 |

## Summary

$N$개 도시, $M$개 버스. 각 버스는 출발 도시에서 도착 도시로 비용이 있다. 출발 도시에서 도착 도시까지 최소 비용을 구하라.
