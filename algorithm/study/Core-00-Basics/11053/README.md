...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 11053 가장 긴 증가하는 부분 수열` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `1차원 DP로 각 위치에서 끝나는 LIS 길이를 누적 계산`
...
- code-first blog series: [../../blog/Core-00-Basics/11053/00-series-map.md](../../blog/Core-00-Basics/11053/00-series-map.md)

## 어떻게 검증하나
- 정식 검증: `make -C study/Core-00-Basics/11053/problem test`
- 대표 실행: `make -C study/Core-00-Basics/11053/problem run-py`
- 비교 실행: `make -C study/Core-00-Basics/11053/problem run-cpp`
