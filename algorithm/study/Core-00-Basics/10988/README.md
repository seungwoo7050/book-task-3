...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 10988 팰린드롬인지 확인하기` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `양끝 포인터(two pointers)로 좌우 문자를 동시에 비교`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-00-Basics/10988/problem test`
- 대표 실행: `make -C study/Core-00-Basics/10988/problem run-py`
