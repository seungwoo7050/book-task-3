...
- 현재 기준 경로: `study/Core-08-DP/1149`
...
### 단계 1-3: 프로젝트 생성, 구현, 테스트

prev/curr 패턴 구현. PASS.
...
- `RGB거리`에서는 `상태와 전이를 명시적으로 정의하고 표나 배열 의미를 끝까지 유지하는 연습`를 실제 명령과 문서 흐름으로 다시 밟아 볼 수 있어야 학습 기록으로서 가치가 생긴다.
