...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 1149 RGB거리` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `집 i를 색 c로 칠할 때 최소 비용을 이전 색 전이로 누적하는 DP`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-08-DP/1149/problem test`
- 대표 실행: `make -C study/Core-08-DP/1149/problem run-py`
