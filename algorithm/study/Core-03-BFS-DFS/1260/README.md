...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 1260 DFS와 BFS` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `동일 그래프에서 DFS와 BFS를 각각 수행해 방문 순서를 출력`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-03-BFS-DFS/1260/problem test`
- 대표 실행: `make -C study/Core-03-BFS-DFS/1260/problem run-py`
