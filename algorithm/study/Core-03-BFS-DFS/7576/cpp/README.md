...
- 실행: `make -C study/Core-03-BFS-DFS/7576/problem run-cpp`
- 검증: `make -C study/Core-03-BFS-DFS/7576/problem test`

## 현재 범위

- 비교 답안: `다중 시작점(multi-source) BFS로 토마토 익는 날짜를 레벨 단위 전파`
