...
| :--- | :--- |
| 상태 | `verified` |
| 문제 배경 | `BOJ 24479 알고리즘 수업 - 깊이 우선 탐색 1` 문제를 현재 학습 구조에서 설명 가능한 풀이 프로젝트로 다시 정리한 항목 |
...
## 이 레포의 답
- 한 줄 답: `정점 번호 오름차순 인접 리스트를 이용한 DFS 방문 순서 기록`
- 공개 답안 위치: `python/src/`
...
## 어떻게 검증하나
- 정식 검증: `make -C study/Core-03-BFS-DFS/24479/problem test`
- 대표 실행: `make -C study/Core-03-BFS-DFS/24479/problem run-py`
