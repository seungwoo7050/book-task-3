# 접근 정리 — BOJ 24479 (알고리즘 수업 - 깊이 우선 탐색 1)
...
- 전략: `정점 번호 오름차순 인접 리스트를 이용한 DFS 방문 순서 기록`
- 공개 구현: `../../python/src/solution.py`
- 정식 검증: `make -C study/Core-03-BFS-DFS/24479/problem test`
...
- 방문 배열 초기화 누락
- 방문 순번 증가 타이밍 오류
- 테스트는 통과했더라도, BOJ 24479 코드 변경 시에는 동일 체크리스트를 다시 실행해야 한다.

## 코드 매핑

- Python 기본 구현: `../../python/src/solution.py`
- 빠른 검증: `make -C study/Core-03-BFS-DFS/24479/problem test`
