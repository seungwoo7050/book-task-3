# 07-monitoring-dashboard-and-review-console-react 문제지
...
정답 코드, 공식 구현 진입점, 해설은 [`07-monitoring-dashboard-and-review-console-react_answer.md`](07-monitoring-dashboard-and-review-console-react_answer.md)에서 확인한다.
