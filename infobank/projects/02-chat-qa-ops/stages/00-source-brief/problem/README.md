...
- 루트 `README.md`와 `docs/curriculum/legacy-intent-audit.md`의 프로젝트 의도
- `docs/curriculum/project-selection-rationale.md`, `docs/curriculum/curriculum-map.md`, `docs/curriculum/reference-spine.md`의 커리큘럼 근거
- `projects/02-chat-qa-ops/capstone/v0-initial-demo`를 baseline으로 삼는 버전 전략
