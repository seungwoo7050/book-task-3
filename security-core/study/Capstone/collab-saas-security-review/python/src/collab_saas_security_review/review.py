        ...
        board.append(
            {
                ...
                "title": f"{item['package']} requires {item['action']}",
...
def render_markdown_report(review: dict[str, Any]) -> str:
    lines = [
        ...
        f"- Crypto findings: `{review['summary']['crypto_findings']}`",
        f"- Auth findings: `{review['summary']['auth_findings']}`",
        f"- Backend findings: `{review['summary']['backend_findings']}`",
        f"- Dependency items: `{review['summary']['dependency_items']}`",
        f"- Remediation items: `{review['summary']['remediation_items']}`",
        "",
        "# Crypto Findings",
    ]
    ...
    lines.extend(["", "# Remediation Board"])
