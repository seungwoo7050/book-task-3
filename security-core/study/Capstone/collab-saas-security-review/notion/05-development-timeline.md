...
- 루트 `README.md`, `docs/roadmap.md`, `study/README.md`, `study/Capstone/README.md`를 capstone `verified` 상태에 맞춰 갱신합니다.
- `CURRICULUM_EXPANSION_PLAN.md`에서 `security-capstone` 행과 `security-core/study/Capstone/` 상태를 올립니다.
