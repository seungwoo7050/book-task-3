...
app = typer.Typer(add_completion=False, help="reference vector로 crypto primitive를 검증합니다.")
...
def demo(profile: Path) -> None:
    typer.echo(json.dumps(demo_from_profile(profile), indent=2, ensure_ascii=False))
