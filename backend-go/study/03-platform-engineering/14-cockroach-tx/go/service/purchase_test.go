...
// TestErrConflictSentinel verifies ErrConflict is a distinct sentinel.
...
// TestPurchaseRequestValidation checks that PurchaseRequest fields are set.
...
// validatePurchaseRequest performs basic validation on a PurchaseRequest.
