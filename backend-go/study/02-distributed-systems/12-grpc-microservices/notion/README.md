# 12 — gRPC Microservices notion/

이 폴더는 `12-grpc-microservices` 프로젝트의 개발 과정과 학습 기록을 담은 블로그형 에세이 모음이다.
...
- **이전**: 11-rate-limiter — Token Bucket, per-client 제한, HTTP 미들웨어
- **현재**: 12-grpc-microservices — Protocol Buffers, unary/streaming RPC, interceptor
- **다음**: 13-distributed-log-core — 분산 로그 코어 구현
