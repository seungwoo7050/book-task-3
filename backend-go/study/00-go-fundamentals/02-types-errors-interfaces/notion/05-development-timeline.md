...
### 2-1. Item struct 작성 (`solution/go/domain/catalog.go`)
...
### 4-1. main.go 작성 (`solution/go/cmd/inventorydemo/main.go`)
...
### 5-1. 테스트 파일 작성 (`solution/go/domain/catalog_test.go`)
