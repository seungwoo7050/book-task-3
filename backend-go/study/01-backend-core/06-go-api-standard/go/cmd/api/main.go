// Package main is the entrypoint for the Go API Standard server.
// It reads configuration from the environment, sets up dependencies,
...
// application holds the dependencies for all handlers, middleware,
// and helpers.
...
// getEnvStr reads a string environment variable or returns a default value.
