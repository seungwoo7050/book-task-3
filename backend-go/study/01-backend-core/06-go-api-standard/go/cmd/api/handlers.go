...
// healthcheckHandler returns the server status and environment.
...
// createMovieHandler handles POST /v1/movies.
...
// listMoviesHandler handles GET /v1/movies with pagination.
...
// validateMovie checks the movie fields and returns a map of validation errors.
