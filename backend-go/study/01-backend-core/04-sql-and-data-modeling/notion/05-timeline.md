...
```bash
mkdir -p 01-backend-core/04-sql-and-data-modeling/{go/cmd/schemawalk,go/catalog,docs/concepts,docs/references,problem}
```
...
### 2-1. SQL 스키마 작성 (`go/catalog/catalog.go`)
...
### 4-1. main.go 작성 (`go/cmd/schemawalk/main.go`)
