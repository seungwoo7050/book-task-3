# 10-cloud-security-control-plane-python 문제지
...
정답 코드, 공식 구현 진입점, 해설은 [`10-cloud-security-control-plane-python_answer.md`](10-cloud-security-control-plane-python_answer.md)에서 확인한다.
