...
from terraform_aws_lab.verify import default_labs_root, run_lab, terraform_available
...
def test_default_labs_root_points_to_project_terraform_dir() -> None:
    assert default_labs_root() == _project_root() / "terraform"
