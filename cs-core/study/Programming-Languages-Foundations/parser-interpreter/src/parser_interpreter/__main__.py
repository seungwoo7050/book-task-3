...
from . import ParserInterpreterError, evaluate_source, format_expr, format_value, parse_source
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        return 0
    except ParserInterpreterError as error:
