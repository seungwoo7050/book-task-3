...
4. 각 프로젝트의 `README.md`: 문제 경계, 구현 경로, 검증 방법
...
- 더 긴 CLI 이력과 당시 초안은 프로젝트별 `notion-archive/`에 남겨 두고, 현재 `notion/`은 다시 실행 가능한 압축판으로 유지합니다.
