...
```bash
cp -r study/product-systems/02-realtime-chat/react-native study/product-systems/03-app-distribution/react-native
```
...
```bash
cd study/product-systems/03-app-distribution/react-native
